...
object AppConfig {
    ...
    const val PREF_SMART_CONNECT = "pref_smart_connect_enabled"
    const val PREF_SUB_UPDATE_ON_START = "pref_sub_update_on_start"
    ...
    const val APP_URL = "$GITHUB_URL/mtpali/v2box"
    const val APP_API_URL = "https://api.github.com/repos/mtpali/v2box/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/mtpali/v2box/main/CR.md"
    const val TG_CHANNEL_URL = "https://www.instagram.com/mobile.tina2/"
    ...
    const val RAY_NG_CHANNEL_NAME = "V2BOX Background Service"
