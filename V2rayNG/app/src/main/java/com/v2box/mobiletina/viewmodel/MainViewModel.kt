...
import com.v2box.mobiletina.AngApplication
...
import com.v2box.mobiletina.extension.matchesPattern
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun findSubscriptionIdBySelect(): String? {
        ...
        return config?.subscriptionId?.takeIf { it.isNotBlank() } ?: AppConfig.DEFAULT_SUBSCRIPTION_ID
    }
