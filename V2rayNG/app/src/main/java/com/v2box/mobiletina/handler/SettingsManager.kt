...
import com.v2box.mobiletina.AppConfig.DEFAULT_SUBSCRIPTION_ID
import com.v2box.mobiletina.AppConfig.GEOIP_PRIVATE
import com.v2box.mobiletina.AppConfig.GEOSITE_PRIVATE
import com.v2box.mobiletina.AppConfig.TAG_DIRECT
import com.v2box.mobiletina.AppConfig.VPN
import com.v2box.mobiletina.dto.V2rayConfig
import com.v2box.mobiletina.dto.entities.ProfileItem
import com.v2box.mobiletina.dto.entities.RulesetItem
import com.v2box.mobiletina.dto.entities.SubscriptionItem
import com.v2box.mobiletina.enums.EConfigType
import com.v2box.mobiletina.enums.Language
import com.v2box.mobiletina.enums.RoutingType
import com.v2box.mobiletina.enums.VpnInterfaceAddressConfig
import com.v2box.mobiletina.handler.MmkvManager.decodeAllServerList
import com.v2box.mobiletina.handler.MmkvManager.decodeServerConfig
import com.v2box.mobiletina.handler.MmkvManager.decodeSubsList
import com.v2box.mobiletina.handler.MmkvManager.decodeSubscription
import com.v2box.mobiletina.handler.MmkvManager.encodeSubscription
import com.v2box.mobiletina.handler.MmkvManager.removeSubscription
...
object SettingsManager {
    ...
    fun getLocale(): Locale {
        ...
        return when (language) {
            Language.AUTO -> if (Utils.getSysLocale().language == "fa") Locale.forLanguageTag("fa") else Locale.ENGLISH
