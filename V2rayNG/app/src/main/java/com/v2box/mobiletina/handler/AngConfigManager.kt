...
import com.v2box.mobiletina.core.CoreConfigManager
import com.v2box.mobiletina.dto.SubscriptionUpdateResult
import com.v2box.mobiletina.dto.UrlContentRequest
...
import com.v2box.mobiletina.extension.isNotNullEmpty
import com.v2box.mobiletina.fmt.CustomFmt
import com.v2box.mobiletina.fmt.Hysteria2Fmt
import com.v2box.mobiletina.fmt.ShadowsocksFmt
import com.v2box.mobiletina.fmt.SocksFmt
import com.v2box.mobiletina.fmt.TrojanFmt
import com.v2box.mobiletina.fmt.VlessFmt
import com.v2box.mobiletina.fmt.VmessFmt
import com.v2box.mobiletina.fmt.WireguardFmt
import com.v2box.mobiletina.util.HttpUtil
    ...
    fun updateConfigViaSub(it: SubscriptionCache): SubscriptionUpdateResult {
        try {
            ...
            var configText = try {
                ...
                val downloaded = HttpUtil.getUrlContentWithUserAgentAndInfo(
                    UrlContentRequest(
                        url = url,
                        userAgent = userAgent,
                        timeout = 15000,
            ...
            if (count > 0) {
                V2BoxSubscriptionInfo.apply(it.subscription, userInfo)
