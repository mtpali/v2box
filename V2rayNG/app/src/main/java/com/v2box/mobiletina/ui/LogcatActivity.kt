...
import com.v2box.mobiletina.databinding.ActivityLogcatBinding
...
import com.v2box.mobiletina.viewmodel.LogcatViewModel
    ...
    private fun shareLogcat() {
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            val result = try {
                ...
                val logFile = File(shareDir, "V2BOX_logcat_$timestamp.txt")
